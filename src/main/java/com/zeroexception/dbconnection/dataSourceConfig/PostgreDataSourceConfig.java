...
@Configuration
@EnableJpaRepositories(basePackages = {"com.zeroexception.dbconnection.serviceLayer.repository"},
...
//    @ConfigurationProperties(prefix = "")
    ...
    postgreEntityManagerFactory(EntityManagerFactoryBuilder builder,
        ...
        factoryBean.setPackagesToScan("com.zeroexception.dbconnection.dataModel");
